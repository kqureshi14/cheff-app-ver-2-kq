...
class FoodieInProgressDetail extends StatefulWidget {
  const FoodieInProgressDetail({Key? key}) : super(key: key);

  @override
  State<FoodieInProgressDetail> createState() => _FoodieInProgressDetailState();
}

class _FoodieInProgressDetailState extends State<FoodieInProgressDetail> {
                        ...
                        Positioned.fill(
                          ...
                          child: Align(
                            ...
                            child: Container(
                              ...
                              child: GeneralText(
                                Strings.foodieProfileStatusLabel.toUpperCase(),
                                style: appTheme
                                    .typographies.interFontFamily.headline6
                                    .copyWith(
                                  fontSize: 12,
