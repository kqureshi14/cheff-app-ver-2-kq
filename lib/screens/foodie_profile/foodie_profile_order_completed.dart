...
class FoodieProfileOrderCompleted extends StatefulWidget {
  const FoodieProfileOrderCompleted({Key? key}) : super(key: key);

  @override
  State<FoodieProfileOrderCompleted> createState() =>
      _FoodieProfileOrderCompletedState();
}

class _FoodieProfileOrderCompletedState
    extends State<FoodieProfileOrderCompleted> {
                        ...
                        Positioned.fill(
                          ...
                          child: Align(
                            ...
                            child: Container(
                              ...
                              child: GeneralText(
                                Strings.foodieProfileOrderCompleted
                                    .toUpperCase(),
                                style: appTheme
                                    .typographies.interFontFamily.headline6
                                    .copyWith(
