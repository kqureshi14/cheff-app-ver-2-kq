...
class ExperienceQuestionireScreen extends StatefulWidget {
  ...
  @override
  _ExperienceQuestionireScreenState createState() => _ExperienceQuestionireScreenState();
}

class _ExperienceQuestionireScreenState extends State<ExperienceQuestionireScreen> {
  @override
      ...
      body: Stack(
        children: [
          Container(
              ...
              child: Image.asset(Resources.expBackgroundPNG,
              fit: BoxFit.cover,)),
          SafeArea(
            child: Column(
    ...
    return GeneralButton.button(
      ...
      onTap: () {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(builder: (context) => const CreateExperienceScreen()),
        );
