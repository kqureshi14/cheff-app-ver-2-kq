...
class ExtoDialog extends StatelessWidget {
  ExtoDialog({
    required GeneralComponentStyle dialogStyle,
    String? title,
    Widget? header,
    Widget? body,
    Widget? image,
  ...
  final GeneralComponentStyle _dialogStyle;
  ...
  DialogTypeData _getHeaderDecorationData({
    ...
    switch (dialogStyle) {
      case GeneralComponentStyle.error:
  ...
  List<Widget> _actionWidgetsBuilder() {
    ...
    for (var action in _actions!) {
      final actionButton = GeneralButton(
        title: action.title,
